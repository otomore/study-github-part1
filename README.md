...
- [ ] [Gitとは](#gitとは)
- [ ] [GitHubとは](#githubとは)
- [ ] [GitHubアカウントを作る](#githubアカウントを作る)
- [ ] [リポジトリ保管庫を作る](#リポジトリ保管庫を作る)
- [ ] [ターミナルにGitをインストールする](#ターミナルにgitをインストールする)
- [ ] [Gitの初期設定](#gitの初期設定)
- [ ] [さっき作ったリポジトリをクローンする](#さっき作ったリポジトリをクローンする)
- [ ] [エディタをインストールする(Atom)](#エディタをインストールするatom)
- [ ] [とりあえずREADME.mdを書く](#とりあえずreadmemdを書く)
- [ ] [リモートリポジトリにpushしてみよう](#リモートリポジトリにpushしてみよう)
- [ ] GitHub Pagesの説明
- [ ] hugoの説明
- [ ] gulpの説明
